...
# Examine cache variable cv_sys_as_$1 for result.

AC_DEFUN(SYS_AS_FEATURE, [
  AC_CACHE_CHECK(whether the assembler supports $1,
                 ...
                 TRY_ASSEMBLE([#include "./m4/assyntax.h"], $2,
                                   cv_sys_as_$1=yes,
                                   cv_sys_as_$1=no))
])
